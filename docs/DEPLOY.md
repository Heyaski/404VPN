...
4. **Выключить журнал запросов** — это обещание в политике конфиденциальности, а не косметика. Настройки → Настройки журнала → снять «Включить журнал запросов». Статистику можно оставить: она агрегатная и доменов не хранит.
