...
4. **Выключить журнал запросов** — это обещание в политике конфиденциальности, а не косметика. **Настройки → Общие настройки**, блок «Журнал запросов» → снять «Включить журнал запросов». Отдельной страницы «Настройки журнала» в свежих версиях нет. Блок «Статистика» рядом можно оставить: она агрегатная и доменов не хранит.
